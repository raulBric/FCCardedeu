...
import { Save, ArrowLeft, Upload, X, Camera, User } from "lucide-react";
...
export default function CrearJugadorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Mapear a estructura de la taula 'jugadors'
      const jugadorDB: Omit<JugadorDB, 'id' | 'created_at' | 'updated_at'> = {
        nom: formData.nombre,
      ...
      await crearJugadorDB(jugadorDB);
      ...
      setErrors({
        form: 'Ha ocorregut un error al crear el jugador. Intenta-ho de nou.'
      });
    } finally {
  ...
  return (
    <DashboardLayout 
      ...
      description="Registra un nou jugador al sistema"
    >
      <div className="mb-6">
        <Button 
          variant="outline" 
